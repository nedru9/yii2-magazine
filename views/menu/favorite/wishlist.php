                    ...
                    <table class="tinvwl-table-manage-list">
                        ...
                        <tr>
                            ...
                            <th class="product-name">
                                <span class="tinvwl-full">Наименование товара</span><span
                                        class="tinvwl-mobile">Товар</span>
                            </th>
                        ...
                        foreach ($products as $product): ?>
                            <tr class="wishlist_item">
                                <td class="product-remove">
                                    <button data-product="<?= $product->id; ?>" class="favorite-remove--js"
                                            type="submit" name="tinvwl-remove" value="58" title="Remove"><i
                                                class="fal fa-times"></i>
                                    </button>
                                </td>
                                <td class="product-thumbnail">
                                    <a href="../site/shop-details.php"><img src="<?= $product->image; ?>"
                                                                            class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                                                            alt="image"></a>
                                </td>
                                <td class="product-name">
                                    <a href="../site/shop-details.php"><?= $product->title; ?></a>
                                </td>
                                    ...
                                    if ($product->count > 0): ?>
                                        <button class="button th-btn" name="tinvwl-add-to-cart" value="58"
                                            ...
                                            <i class="fal fa-shopping-cart"></i><span
                                                    class="tinvwl-txt">В корзину</span>
                                        </button>
                                    <?php
                                    endif; ?>
                                </td>
