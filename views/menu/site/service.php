        ...
        <div class="row gy-40 justify-content-center">
            <div class="col-xl-4 col-md-6">
                <div class="service-card">
                    ...
                    <div class="box-content" data-mask-src="assets/img/bg/service_card_shape.png">
                        <h3 class="box-title"><a href="service-details.php">Fresh Vegetable</a></h3>
                        <p class="box-text">Inspections to ensure compliance with organic standards.</p>
                    </div>
                    <a href="service-details.php" class="icon-btn"><i class="far fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="service-card">
                    ...
                    <div class="box-content" data-mask-src="assets/img/bg/service_card_shape.png">
                        <h3 class="box-title"><a href="service-details.php">Organic Fertilizer</a></h3>
                        <p class="box-text">Inspections to ensure compliance with organic standards.</p>
                    </div>
                    <a href="service-details.php" class="icon-btn"><i class="far fa-arrow-right"></i></a>
                </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="service-card">
                    ...
                    <div class="box-content" data-mask-src="assets/img/bg/service_card_shape.png">
                        <h3 class="box-title"><a href="service-details.php">Natural Fruits</a></h3>
                        <p class="box-text">Inspections to ensure compliance with organic standards.</p>
                    </div>
                    <a href="service-details.php" class="icon-btn"><i class="far fa-arrow-right"></i></a>
                </div>
    ...
    <div class="container z-index-common">
        <div class="cta-box mega-hover" data-bg-src="assets/img/bg/cta_bg_5_1.jpg">
            <div class="box-content">
                ...
                <a href="shop-details.php" class="th-btn">Shop Now<i class="fas fa-chevrons-right ms-2"></i></a>
            </div>
        </div>
    </div>
</section>
...
<section class="overflow-hidden bg-smoke2 space" id="testi-sec">
    <div class="shape-mockup d-none d-xxl-block" data-bottom="0" data-left="0"><img
                src="assets/img/shape/food_shape_3.png" alt="shape"></div>
    <div class="shape-mockup d-none d-xxl-block" data-bottom="0" data-right="0"><img
                src="assets/img/shape/food_shape_4.png" alt="shape"></div>
    <div class="container">
        <div class="slider-area testi-grid-area">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="testi-grid">
                            ...
                            <p class="testi-grid_text"><span>“</span>Some studies suggest that organic foods may have
                                higher levels of certain nutrients and antioxidants compared to conventionally grown
                                foods. However, this can vary depending on factors like soil quality and growing
                                conditions.<span>”</span></p>
                            <h4 class="testi-grid_name">Alex Hamilton - <span class="testi-grid_desig">Doctor</span>
                            </h4>
                    ...
                    <div class="swiper-slide">
                        <div class="testi-grid">
                            ...
                            <p class="testi-grid_text"><span>“</span>Some studies suggest that organic foods may have
                                ...
                                foods. However, this can vary depending on factors like soil quality and growing
                                conditions.<span>”</span></p>
                            <h4 class="testi-grid_name">Jasemin Jui - <span class="testi-grid_desig">Consultant</span>
                            </h4>
                            <div class="testi-grid_review">
                                <i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i
                                        class="fa-sharp fa-solid fa-star"></i><i
                    ...
                    <div class="swiper-slide">
                        <div class="testi-grid">
                            ...
                            <p class="testi-grid_text"><span>“</span>Some studies suggest that organic foods may have
                                ...
                                foods. However, this can vary depending on factors like soil quality and growing
                                conditions.<span>”</span></p>
                            <h4 class="testi-grid_name">Martin Danial - <span class="testi-grid_desig">Doctor</span>
                            </h4>
                            <div class="testi-grid_review">
                                <i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i
                                        class="fa-sharp fa-solid fa-star"></i><i
            ...
            <button data-slider-prev="#testiSlide1" class="slider-arrow slider-prev"><i class="far fa-arrow-left"></i>
            </button>
            <button data-slider-next="#testiSlide1" class="slider-arrow slider-next"><i class="far fa-arrow-right"></i>
            </button>
        </div>
    </div>
</section>
            ...
            <div class="col-xl-6">
                <div class="offer-block mega-hover" data-bg-color="#F3EEC1">
                    ...
                    <div class="box-content" data-border="#F3EEC1">
                        ...
                        <a href="shop-details.php" class="th-btn btn-sm">Shop Now<i
            ...
            <div class="row justify-content-between">
                    ...
                    <div class="widget footer-widget">
                        <div class="th-widget-about">
                            <div class="about-logo">
                                <a href="home-organic-farm.php"><img src="assets/img/logo-footer.svg" alt="Frutin"></a>
                            </div>
                            <p class="about-text">We provide specialized winterization services to safeguard your pool
                                during the off-season, and when spring arrives, we handle the thorough opening
                                process.</p>
                            <div class="th-social">
                ...
                <div class="col-md-6 col-xl-auto">
                    <div class="widget widget_nav_menu footer-widget">
                        <h3 class="widget_title"><img src="assets/img/theme-img/title_icon.svg" alt="Icon">Quick Links
                        </h3>
                ...
                <div class="col-md-6 col-xl-auto">
                    <div class="widget footer-widget">
                        <h3 class="widget_title"><img src="assets/img/theme-img/title_icon.svg" alt="Icon">Contact Us
                        </h3>
                    ...
                    <div class="widget footer-widget">
                        ...
                        <div class="sidebar-gallery">
                            <div class="gallery-thumb">
                                ...
                                <a href="assets/img/widget/gallery_1_1.jpg" class="gallery-btn popup-image"><i
                                            class="fab fa-instagram"></i></a>
                            </div>
                            <div class="gallery-thumb">
                                <img src="assets/img/widget/gallery_1_2.jpg" alt="Gallery Image">
                                <a href="assets/img/widget/gallery_1_2.jpg" class="gallery-btn popup-image"><i
                                            class="fab fa-instagram"></i></a>
                            </div>
                            <div class="gallery-thumb">
                                <img src="assets/img/widget/gallery_1_3.jpg" alt="Gallery Image">
                                <a href="assets/img/widget/gallery_1_3.jpg" class="gallery-btn popup-image"><i
                                            class="fab fa-instagram"></i></a>
                            </div>
                            <div class="gallery-thumb">
                                <img src="assets/img/widget/gallery_1_4.jpg" alt="Gallery Image">
                                <a href="assets/img/widget/gallery_1_4.jpg" class="gallery-btn popup-image"><i
                                            class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row gy-2 align-items-center">
                <div class="col-md-6">
                    <p class="copyright-text">Copyright <i class="fal fa-copyright"></i> 2023 <a
                                href="home-organic-farm.php">Frutin</a>. All Rights Reserved.</p>
                </div>
