            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-auto">
                    <div class="header-logo">
                        <a href="home-organic-farm.php"><img src="assets/img/logo.svg" alt="Frutin"></a>
                    </div>
                </div>
                <div class="col-auto">
                    <nav class="main-menu d-none d-lg-inline-block">
                        <ul>
                            <li class="menu-item-has-children">
                                <a href="home-organic-farm.php">Home</a>
                                <ul class="sub-menu">
                ...
                <div class="col-auto d-none d-xl-block">
                    <div class="header-button">
                        ...
                        <a href="shop.php" class="th-btn style4">Shop Now<i class="fas fa-chevrons-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row gy-30">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="th-team team-card">
                    ...
                    <div class="box-content">
                        ...
                        <h3 class="box-title"><a href="team-details.php">Alhando Robert</a></h3>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="th-team team-card">
                    ...
                    <div class="box-content">
                        ...
                        <h3 class="box-title"><a href="team-details.php">Eliana Bellingham</a></h3>
                        <div class="social-links">
                            <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                            <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a target="_blank" href="https://instagram.com/"><i class="fab fa-instagram"></i></a>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="th-team team-card">
                    ...
                    <div class="box-content">
                        <span class="team-desig">Senior Farmers</span>
                        <h3 class="box-title"><a href="team-details.php">Emanuel Macule</a></h3>
                        <div class="social-links">
                            <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                            <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a target="_blank" href="https://instagram.com/"><i class="fab fa-instagram"></i></a>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="th-team team-card">
                    ...
                    <div class="box-content">
                        <span class="team-desig">Junior Farmers</span>
                        <h3 class="box-title"><a href="team-details.php">Poppy Joanne</a></h3>
                        <div class="social-links">
                            <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                            <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a target="_blank" href="https://instagram.com/"><i class="fab fa-instagram"></i></a>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="th-team team-card">
                    ...
                    <div class="box-content">
                        <span class="team-desig">Senior Farmers</span>
                        <h3 class="box-title"><a href="team-details.php">Henry Haninkot</a></h3>
                        <div class="social-links">
                            <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                            <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a target="_blank" href="https://instagram.com/"><i class="fab fa-instagram"></i></a>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="th-team team-card">
                    ...
                    <div class="box-content">
                        <span class="team-desig">Junior Farmers</span>
                        <h3 class="box-title"><a href="team-details.php">Saima Samuel</a></h3>
                        <div class="social-links">
                            <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                            <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a target="_blank" href="https://instagram.com/"><i class="fab fa-instagram"></i></a>
