        ...
        <div class="container">
            <div class="row gy-30">
                <div class="col-xl-4 col-md-6">
                    <div class="gallery-card style-hover">
                        <div class="box-img">
                            ...
                            <a href="assets/img/gallery/gallery_2_1.jpg" class="icon-btn style2 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                        <div class="box-content">
                            <p class="box-subtitle">Fresh Food & Vegetables</p>
                            <h3 class="box-title"><a href="project-details.php">Fresh Vegetables</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="gallery-card style-hover">
                        <div class="box-img">
                            ...
                            <a href="assets/img/gallery/gallery_2_2.jpg" class="icon-btn style2 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                        <div class="box-content">
                            <p class="box-subtitle">Fresh Food & Vegetables</p>
                            <h3 class="box-title"><a href="project-details.php">Organic Vegetables</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="gallery-card style-hover">
                        <div class="box-img">
                            ...
                            <a href="assets/img/gallery/gallery_2_3.jpg" class="icon-btn style2 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                        <div class="box-content">
                            <p class="box-subtitle">Fresh Food & Vegetables</p>
                            <h3 class="box-title"><a href="project-details.php">Organic Fruits</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="gallery-card style-hover">
                        <div class="box-img">
                            ...
                            <a href="assets/img/gallery/gallery_2_4.jpg" class="icon-btn style2 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                        <div class="box-content">
                            <p class="box-subtitle">Fresh Food & Vegetables</p>
                            <h3 class="box-title"><a href="project-details.php">Organic Farming</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="gallery-card style-hover">
                        <div class="box-img">
                            ...
                            <a href="assets/img/gallery/gallery_2_5.jpg" class="icon-btn style2 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                        <div class="box-content">
                            <p class="box-subtitle">Fresh Food & Vegetables</p>
                            <h3 class="box-title"><a href="project-details.php">Fresh Vegetables</a></h3>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="gallery-card style-hover">
                        <div class="box-img">
                            ...
                            <a href="assets/img/gallery/gallery_2_6.jpg" class="icon-btn style2 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                        <div class="box-content">
                            <p class="box-subtitle">Fresh Food & Vegetables</p>
                            <h3 class="box-title"><a href="project-details.php">Organic Vegetables</a></h3>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="gallery-card style-hover">
                        <div class="box-img">
                            ...
                            <a href="assets/img/gallery/gallery_2_7.jpg" class="icon-btn style2 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                        <div class="box-content">
                            <p class="box-subtitle">Fresh Food & Vegetables</p>
                            <h3 class="box-title"><a href="project-details.php">Organic Fruits</a></h3>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="gallery-card style-hover">
                        <div class="box-img">
                            <img src="assets/img/gallery/gallery_2_8.jpg" alt="gallery image">
                            <a href="assets/img/gallery/gallery_2_8.jpg" class="icon-btn style2 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                        <div class="box-content">
                            <p class="box-subtitle">Fresh Food & Vegetables</p>
                            <h3 class="box-title"><a href="project-details.php">Organic Farming</a></h3>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="gallery-card style-hover">
                        <div class="box-img">
                            <img src="assets/img/gallery/gallery_2_9.jpg" alt="gallery image">
                            <a href="assets/img/gallery/gallery_2_9.jpg" class="icon-btn style2 popup-image"><i class="far fa-plus"></i></a>
                        </div>
                        <div class="box-content">
                            <p class="box-subtitle">Fresh Food & Vegetables</p>
                            <h3 class="box-title"><a href="project-details.php">Organic Farming</a></h3>
